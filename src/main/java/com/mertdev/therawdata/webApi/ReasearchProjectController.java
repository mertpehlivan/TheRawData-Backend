...
public class ReasearchProjectController {
	...
	public List<GetPostResponse> getAllReasearchProject(@PathVariable String uniqueName, Pageable pageable) {

		return projectService.getAllReasearchProject(uniqueName, pageable);
	}
}
